...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_RESPONSEM']._serialized_start=82
  _globals['_RESPONSEM']._serialized_end=109
  _globals['_CHATSERVICE']._serialized_start=111
